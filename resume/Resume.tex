...
\location{ Worked on a development team to plan to design and develop an application to process quotes, make requests for parts as well as to track shipments }
